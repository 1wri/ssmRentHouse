# 基于spring+jsp的房屋租赁系统带项目论文



## 一、介绍

技术栈：Java、Mysql、Spring、Mybatis、jSP、servlet


系统用户：用户、管理员


用户：注册登录、首页 、我要租房 、租前须知、求租列表、我的合同


管理员： 登录、 求租管理、 房屋管理、 留言管理、 房东申请管理 我要租房、 求租列表、我想留言、合同模板 、我的求租 、我的留言板 、数据统计 、个人资料 、账户设置 、我的账单
...
链接: https://pan.baidu.com/s/1viEzXsYo9CHcyBsurXLP6g?pwd=r9m8 提取码: r9m8
--来自百度网盘超级会员v3的分享
